## xacro (kilted) - 2.1.1-1

The packages in the `xacro` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted xacro` on `Thu, 28 Aug 2025 18:34:28 -0000`
...
## xacro (humble) - 2.1.1-1

The packages in the `xacro` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble xacro` on `Thu, 28 Aug 2025 18:33:00 -0000`
...
The packages in the `xacro` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy xacro` on `Thu, 28 Aug 2025 18:31:35 -0000`
...
## xacro (rolling) - 2.1.1-1

The packages in the `xacro` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling xacro` on `Thu, 28 Aug 2025 18:24:44 -0000`
...
## xacro (kilted) - 2.1.0-1

The packages in the `xacro` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted xacro` on `Wed, 20 Aug 2025 09:58:00 -0000`
...
- upstream repository: https://github.com/ros/xacro.git
- release repository: https://github.com/ros2-gbp/xacro-release.git
- rosdistro version: `2.0.13-2`
- old version: `2.0.13-2`
- new version: `2.1.0-1`
...
The packages in the `xacro` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy xacro` on `Wed, 20 Aug 2025 09:10:33 -0000`
...
## xacro (humble) - 2.1.0-1

The packages in the `xacro` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble xacro` on `Wed, 20 Aug 2025 08:03:36 -0000`
